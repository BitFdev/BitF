...
In order to support loading of multiple wallets in BitF-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is BitF.cpp.
...
Changes to BitF.cpp
----------------------
BitF.cpp is the entry point into BitF-qt, and as such, will require some minor modifications to provide hooks for
