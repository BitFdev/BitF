...
Intro
-----
BitF (BitF) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. BitF utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run BitF-qt.exe.

BitF Core is the original BitF client and it builds the backbone of the network.
However, it downloads and stores the entire history of BitF transactions;
