...
RESOURCES += src/qt/BitF.qrc src/qt/BitF_locale.qrc

TRANSLATIONS += src/qt/locale/BitF_bg.ts \
                src/qt/locale/BitF_de.ts \
                src/qt/locale/BitF_en.ts \
                src/qt/locale/BitF_es.ts \
                src/qt/locale/BitF_fi.ts \
                src/qt/locale/BitF_fr.ts \
                src/qt/locale/BitF_it.ts \
                src/qt/locale/BitF_ja.ts \
                src/qt/locale/BitF_pl.ts \
                src/qt/locale/BitF_pt.ts \
                src/qt/locale/BitF_ru.ts \
                src/qt/locale/BitF_sk.ts \
                src/qt/locale/BitF_sv.ts \
                src/qt/locale/BitF_vi.ts \
                src/qt/locale/BitF_zh_CN.ts \
                src/qt/locale/BitF_zh_TW.ts
