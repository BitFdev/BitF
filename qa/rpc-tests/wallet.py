...
#   c) node1 mines 32 blocks, so now node 0 has 500000BitF, node 1 has 4250BitF, node2 has none.
#   d) node0 sends 601 BitF to node2, in two transactions (301 BitF, then 300 BitF).
