                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BitF Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitF address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BitF: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BitF Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitF Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitF"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitF addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitF addresses"));
    ...
    openAction->setStatusTip(tr("Open a BitF: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitF Core help message to get a list with possible BitF command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BitF Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitF network", "", count));
}
...
{
    QString strTitle = tr("BitF Core"); // default title
