...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitF features */
        {"BitF", "masternode", &masternode, true, true, false},
        {"BitF", "listmasternodes", &listmasternodes, true, true, false},
        {"BitF", "getmasternodecount", &getmasternodecount, true, true, false},
        {"BitF", "masternodeconnect", &masternodeconnect, true, true, false},
        {"BitF", "masternodecurrent", &masternodecurrent, true, true, false},
        {"BitF", "masternodedebug", &masternodedebug, true, true, false},
        {"BitF", "startmasternode", &startmasternode, true, true, false},
        {"BitF", "createmasternodekey", &createmasternodekey, true, true, false},
        {"BitF", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"BitF", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"BitF", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"BitF", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"BitF", "getmasternodescores", &getmasternodescores, true, true, false},
        {"BitF", "mnbudget", &mnbudget, true, true, false},
        {"BitF", "preparebudget", &preparebudget, true, true, false},
        {"BitF", "submitbudget", &submitbudget, true, true, false},
        {"BitF", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"BitF", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"BitF", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"BitF", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"BitF", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"BitF", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"BitF", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"BitF", "checkbudgets", &checkbudgets, true, true, false},
        {"BitF", "mnsync", &mnsync, true, true, false},
        {"BitF", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> BitF-cli " + methodname + " " + args + "\n";
}
