Contributing to BitF Core
==================================

The BitF Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BitF Core project, and is not to be
confused with overall BitF Network Protocol consensus changes.

Whether a pull request is merged into BitF Core rests with the project merge
...
Patches that change BitF consensus rules are considerably more involved than
...
Where a patch set proposes to change the BitF consensus, it must have been
...
The project leader is the release manager for each BitF Core release.
